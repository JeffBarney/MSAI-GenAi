...
from hyperparameters import IMAGE_SIZE, BATCH_SIZE, EMA
...
class DiffusionModel(models.Model):
    ...
    def test_step(self, images):
        ...
        noise_loss = self.loss(noises, pred_noises) # not sure if self.loss is part of models.Models or not defined
        self.noise_loss_tracker.update_state(noise_loss) # same here about noise_loss_tracker
        return {m.name: m.result() for m in self.metrics}
